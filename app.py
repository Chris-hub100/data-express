...
def product_page(network):
    ...
    pricing = {
        # --- DATA BUNDLES ---
        "mtn": [
            {"name": "1GB Non-Expiry", "price": 5.5, "input_type": "phone", "active": False}, 
            {"name": "2GB Non-Expiry", "price": 10.5, "input_type": "phone", "active": False},
            {"name": "3GB Non-Expiry", "price": 15, "input_type": "phone", "active": False},
            {"name": "4GB Non-Expiry", "price": 20, "input_type": "phone", "active": False},
            {"name": "5GB Non-Expiry", "price": 25, "input_type": "phone", "active": False },
            {"name": "6GB Non-Expiry", "price": 28, "input_type": "phone", "active": False},
            {"name": "8GB Non-Expiry", "price": 37, "input_type": "phone", "active": False},
            {"name": "10GB Non-Expiry", "price": 46, "input_type": "phone", "active": False},
            {"name": "15GB Non-Expiry", "price": 66, "input_type": "phone", "active": False},
            {"name": "20GB Non-Expiry", "price": 88, "input_type": "phone", "active": False},
            {"name": "30GB Non-Expiry", "price": 132, "input_type": "phone", "active": False},
            {"name": "40GB Non-Expiry", "price": 180, "input_type": "phone", "active": False},
            {"name": "50GB Non-Expiry", "price": 215, "input_type": "phone", "active": False},
            {"name": "100GB Non-Expiry", "price": 430, "input_type": "phone", "active": False},
        ],
        "telecel": [
        ...
        # --- VOUCHERS ---
        "audiomack": [
            {"name": "Audiomack Day Pass", "price": 3, "input_type": "email", "active": False},
            {"name": "Audiomack Monthly Pass", "price": 25, "input_type": "email", "active": False}
        ],
         "tinder": [
            {"name": "Standard 1 Week - Plus", "price":25, "input_type": "phone", "active": False},
            {"name": "Standard 1 Week - Gold", "price": 35, "input_type": "phone", "active": False},
            {"name": "Standard 1 Month - Plus", "price": 42, "input_type": "phone", "active": False},
            {"name": "Standard 1 Month - Gold", "price": 55, "input_type": "phone", "active": False},
        ],
        "fcmobile": [
            {"name": "40 FC Points", "price": 7, "input_type": "id", "active": False},
            {"name": "100 FC Points", "price": 17, "input_type": "id", "active": False},
            {"name": "520 FC Points", "price": 80, "input_type": "id", "active": False},
            {"name": "1070 FC Points", "price": 160, "input_type": "id", "active": False},
            {"name": "2200 FC Points", "price": 310, "input_type": "id", "active": False},
            {"name": "5750 FC Points", "price": 775, "input_type": "id", "active": False},
            {"name": "12000 FC Points", "price": 1570, "input_type": "id", "active": False},
        ],
        "freefire": [
            {"name": "100 Diamonds", "price": 18, "input_type": "id", "active": False},
            {"name": "210 Diamonds", "price": 32, "input_type": "id", "active": False},
            {"name": "530 Diamonds", "price": 72, "input_type": "id", "active": False},
            {"name": "1080 Diamonds", "price": 142, "input_type": "id", "active": False},
            {"name": "2200 Diamonds", "price": 275, "input_type": "id", "active": False},
        ],
        "codm": [
            {"name": "880 CP", "price": 145, "input_type": "id", "active": False},
            {"name": "30 CP", "price": 7, "input_type": "id", "active": False},
            {"name": "80 CP", "price": 15, "input_type": "id", "active": False},
            {"name": "420 CP", "price": 72, "input_type": "id", "active": False},
            {"name": "2400 CP", "price": 370, "input_type": "id", "active": False},
            {"name": "5000 CP", "price": 730, "input_type": "id", "active": False},
            {"name": "10800 CP", "price": 1440, "input_type": "id", "active": False},
            {"name": "21600 CP", "price": 2600, "input_type": "id", "active": False},
            {"name": "32400 CP", "price": 3800, "input_type": "id", "active": False},
            {"name": "54000 CP", "price": 6200, "input_type": "id", "active": False}
        ],
        "fcmobile.": [
            {"name": "39 Silver", "price": 8, "input_type": "id", "active": False},
            {"name": "99 Silver", "price": 18, "input_type": "id", "active": False},
            {"name": "499 Silver", "price": 82, "input_type": "id", "active": False},
            {"name": "1999 Silver", "price": 317, "input_type": "id", "active": False},
            {"name": "4999 Silver", "price": 780, "input_type": "id", "active": False},
            {"name": "9999 Silver", "price": 1550, "input_type": "id", "active": False},
        ],
        "codm.": [
            {"name": "Battle Pass Premium", "price": 40, "input_type": "id", "active": False},
            {"name": "Battle Pass Premium Bundle", "price": 93, "input_type": "id", "active": False}
        ],
         "marvelrivals": [
            {"name": "100 Lattices", "price": 15, "input_type": "id", "active": False},
            {"name": "500 Lattices", "price": 70, "input_type": "id", "active": False},
            {"name": "1000 Lattices", "price": 142, "input_type": "id", "active": False},
            {"name": "2180 Lattices", "price": 283, "input_type": "id", "active": False},
            {"name": "5680 Lattices", "price": 660, "input_type": "id", "active": False},
            {"name": "11680 Lattices", "price": 1310, "input_type": "id", "active": False},
        ],
        "deltaforce": [
            {"name": "18 Delta Coins", "price": 5.5, "input_type": "id", "active": False},
            {"name": "30 Delta Coins", "price": 9, "input_type": "id", "active": False},
            {"name": "60 Delta Coins", "price": 14, "input_type": "id", "active": False},
            {"name": "320 Delta Coins", "price": 60, "input_type": "id", "active": False},
            {"name": "460 Delta Coins", "price": 82, "input_type": "id", "active": False},
            {"name": "750 Delta Coins", "price": 115, "input_type": "id", "active": False},
        ],
        "honorofkings": [
            {"name": "16 Tokens", "price": 5, "input_type": "id", "active": False},
            {"name": "80 Tokens", "price": 15, "input_type": "id", "active": False},
            {"name": "240 Tokens", "price": 40, "input_type": "id", "active": False},
            {"name": "400 Tokens", "price": 65, "input_type": "id", "active": False},
            {"name": "560 Tokens", "price": 90, "input_type": "id", "active": False},
            {"name": "830 Tokens", "price": 130, "input_type": "id", "active": False},
        ],
        "arenabreakout": [
            {"name": "66 Bonds", "price": 15, "input_type": "id", "active": False},
            {"name": "335 Bonds", "price": 66, "input_type": "id", "active": False},
            {"name": "675 Bonds", "price": 130, "input_type": "id", "active": False},
            {"name": "1690 Bonds", "price": 317, "input_type": "id", "active": False},
            {"name": "3400 Bonds", "price": 630, "input_type": "id", "active": False},
            {"name": "6820 Bonds", "price": 1255, "input_type": "id", "active": False},
        ]
    }
